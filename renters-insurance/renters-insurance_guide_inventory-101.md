...
You can pay for an inventory app or service or even use a simple spreadsheet program, but there are plenty of free options to make things easier.
...
Be aware that some apps include "social sharing" features, so make sure you can keep your information private before you choose one to use.
...
#### **Save a copy of your inventory off-site**
...
[Next__](shopping-tips-and-application)
