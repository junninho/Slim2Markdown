...
## Standard renters insurance terms

If you understand these basic terms, you'll be able to quickly compare plans and find the best renters insurance policy for your needs.

To start with, **there are two general policy types:**

  * Replacement Cost
  * It pays for what it costs to _repair or replace_ your stuff.



**Replacement Cost Value (RCV)** means the size of your claim settlement is determined by how much it will cost to repair or replace your belongings at current prices.

_This is the more expensive of the two policy types._

Example:  
If your sofa is stolen, it pays for the cost of a new replacement sofa.

  * Actual Cash Value
  * It pays for what your stuff _is currently worth_.



**Actual Cash Value (ACV)** (also called depreciated loss coverage) means the size of your claim settlement is determined by the _depreciated_ value of your belongings.

_This is the cheaper of the two policy types._

Example:  
If your sofa is stolen, it pays what the sofa is currently worth after depreciation.

### Perils

"Perils" refer to the causes of loss or damage that the policy will cover.

  * "All Risk" policies cover any peril not explicitly excluded elsewhere in the contract.
  * "Named Perils" policies cover only the perils explicitly listed.



Either way, make sure you read closely both the Perils and the Exclusions so you know exactly what’s covered.

### Exclusions

If an insurer won't cover a specific kind of event or asset, you'll find it listed under the Exclusions section of the policy.

### Dollar Limits

Insurers limit the total amount they'll pay for property that’s expensive or difficult to appraise. For example, your jewelry or family heirloom may be subject to a $2,500 settlement limit, even if your policy covers $30,000 total.

### Personal property endorsements

The way to get around dollar limits is to buy policy add-ons that add extra protection for specific items or categories. These endorsements—also called floaters or riders—increase coverage only for the items listed. They cost extra, but they typically don't add new deductible requirements.

### Additional living expenses (ALE)

If you're forced to stay elsewhere because your home has become uninhabitable, your insurer may pay for the hotel fees and meal expenses if your policy covers ALE. (Sometimes it's called "loss of usage," or LOU.) Most policies do, but read the fine print to make sure.
...
[__](/renters-insurance/guide)

[Next__](real-claims-stories)
