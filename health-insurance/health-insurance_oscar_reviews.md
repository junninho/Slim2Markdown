...
Although Oscar is still too new to have the ratings history of other more established health insurance companies, its plan offerings and perks are often hard to beat. From free benefits (primary care visits, lab tests and generic drugs) to a doctor-on-call service to a best-in-class website and mobile app, Oscar's offering exceeds a lot of traditional plans. It's generally among the more affordable plans at a given benefit level; however, its provider network is generally smaller than that of the larger, brand name insurers. 
