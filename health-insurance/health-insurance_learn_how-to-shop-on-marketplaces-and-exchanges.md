...
Still have questions? Keep reading for our answers to all of your major questions on the health insurance exchanges.
...
All plans on Healthcare.gov must provide the [ten essential benefits](/health-insurance/faq/essential-benefits-covered-in-all-health-plans/). Depending on your state, plans may need to cover additional services in order to be sold on the marketplace. Additionally, health insurance companies that provide plans on Healthcare.gov must have a plan available for each of the four metal tiers. The metal tiers - bronze, silver, gold, and platinum - help shoppers understand the cost-sharing split between them and the insurance company and compare plans apples-to-apples.
...
Creating a Healthcare.gov login in is relatively straightforward:

  1. Visit the Create an account page on Healthcare.gov
  2. Enter basic information about yourself, like name, address, and email
  3. Choose your username and password
  4. Create your security questions for added account security
  5. Click the "Create Account" button
  6. Answer questions based on information from your credit report in order to verify your identity. They will ask for your Social Security Number, and if your information doesn't match the Social Security Database, e.g., you recently changed your last name, you may have trouble making an account. If your identity cannot be verified online, you'll see a message instructing you on what to do next
  7. If your account has been successfully created, you will see a success screen



![Healthcare.gov account](https://dato-images.imgix.net/242/1476673770-heartcare-gov-account.png)

Have trouble making an account? You can call the Marketplace Call Center at 1-800-318-2596.

### State health insurance exchanges

Currently, twelve states and the District of Columbia have built their own marketplaces for individuals and families: [California](http://www.coveredca.com/), [Colorado](http://connectforhealthco.com), [Connecticut](https://www.accesshealthct.com/AHCT/LandingPageCTHIX), [District of Columbia](https://dchealthlink.com/), [Idaho](https://www.yourhealthidaho.org/), [Kentucky](https://kynect.ky.gov/), [Maryland](https://www.marylandhealthconnection.gov/), [Massachusetts](https://www.mahealthconnector.org/), [Minnesota](https://www.mnsure.org/), [New York](https://nystateofhealth.ny.gov/), [Rhode Island](http://healthsourceri.com/), [Vermont](https://portal.healthconnect.vermont.gov/maintenance/SiteUnavailable.html), and [Washington](https://www.wahealthplanfinder.org/_content/Homepage.html).

In general, state marketplaces work the same way as the federal health insurance exchange. The big difference is that the state, not the federal government, is in charge of all aspects of the health insurance exchange.

This also means that the state has more control over the health insurance policies available on their exchange. States who build their own marketplaces can place additional rules on health insurance policies, requiring them to cover additional services, for example. States can also set different quality and pricing guidelines for policies.
...
Besides the federal and state health insurance marketplaces, there are also private health insurance exchanges, such as PolicyGenius.
...
How are off-exchange plans different? Primarily, they allow health insurers to structure their plans in different ways and potentially save the customer money. For example, state and federal exchanges require that participating insurers provide a plan at every metal tier. However, an insurer may only want to offer a single Gold tier plan. With off-exchange plans, they can do that.

Private health insurance exchanges like PolicyGenius can also provide different shopping support for customers. At PolicyGenius, for example, we have designed our marketplace to help customers find the right plan for their budget by balancing their different needs. Shopping for health insurance is all about compromise - you may decide you're willing to pay more every month in order to get a lower deductible, for example. PolicyGenius is designed to help you navigate those compromises.
...
If you're planning on shopping on one of the marketplaces, make sure that you're shopping during Open Enrollment (or that you qualify for a Special Enrollment Period). Here are the dates for Open Enrollment 2017:

  * If you apply between November 1, 2016 and December 15, 2016, your health insurance will begin on January 1, 2017
  * If you apply between December 16, 2016 and January 15, 2017, your health insurance will begin on February 1, 2017
  * If you apply between January 16, 2017 and January 31, 2017, your health insurance will begin on March 1, 2017
...
You can also shop on a private exchange like PolicyGenius. As we mentioned above, private exchanges may be able to show you additional options. These additional options, often off-exchange plans, may be better suited for your needs and budget. When you find a plan through PolicyGenius, you'll fill out a short online application, then complete the process with a quick phone call with a licensed agent. The agent will verify your identity, check on your eligibility for a premium subsidy, and answer any additional questions you have about your plan.
