...
Health Maintenance Organizations (HMOs) are a type of health insurance plan that limit coverage to a particular network or networks of doctors and hospitals. Some HMO plans require that you choose a primary care physician, through which you will need to get a referral in order to see a specialist.
