...
The entire application process generally takes 4–6 weeks. The common cause of longer processing times is an applicant with a complex health history, whose doctor needs to submit medical records to the insurance company.
...
#### **What to expect**
  ...
  * Complete a 2-page application covering basic info and job details.
  * Be prepared to provide income documentation—either your latest tax return or employment offer letter (if changing jobs).
  * You’ll have to sign authorization forms for release of health information to the insurer.
  


#### **Then what?**

  * Submit the signed application and authorizations to your broker (or the insurer directly, depending on the circumstances.
  * You will be called or emailed to schedule a paramedical exam and phone interview at your convenience.
...
#### **What to expect**
  ...
  * The technician will measure height, weight, blood pressure and pulse.
  * The technician will also take a blood sample and urine sample.
  


#### **Then what?**

  * The results of your exam (including the blood profile and urine screening results) will be submitted to the insurer’s underwriters.
  * Additional medical records may be requested from your physician(s), as necessary.
...
#### **What to expect**
  ...
  * Assuming everything is in good order, your case will go to underwriting for final approval.
  * The insurer may contact you if they need additional information.
...
#### **All done.**  
Congrats – You're an LTD insurance PolicyGenius!

[__Next Steps](/long-term-disability-insurance/guide/next-steps)
